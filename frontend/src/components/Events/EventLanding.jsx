...
const EventLanding = () => {
  ...
  const eventTypeConfig = {
    Hackathon: {
      ...
      bgColorDark:
        "bg-gradient-to-br from-purple-900/10 to-indigo-900/10 border-purple-500/20",
    ...
    Workshop: {
      ...
      bgColorDark:
        "bg-gradient-to-br from-emerald-900/10 to-teal-900/10 border-emerald-500/20",
    ...
    Seminar: {
      ...
      bgColorDark:
        "bg-gradient-to-br from-blue-900/10 to-cyan-900/10 border-blue-500/20",
    ...
    "Case Study": {
      ...
      bgColorDark:
        "bg-gradient-to-br from-pink-900/10 to-rose-900/10 border-pink-500/20",
    ...
    "Creative Showcase": {
      ...
      bgColorDark:
        "bg-gradient-to-br from-orange-900/10 to-red-900/10 border-orange-500/20",
    ...
    Other: {
      ...
      bgColorDark:
        "bg-gradient-to-br from-gray-900/10 to-slate-900/10 border-gray-500/20",
  ...
  const handleRegister = async (eventId) => {
    ...
    try {
      ...
      // await axios.post(`${import.meta.env.VITE_API_BASE_URL}/registration/${eventId}/register`, {}, { withCredentials: true })
      await axios.post(
        `${import.meta.env.VITE_API_BASE_URL}/registration/${eventId}/register`,
        {},
        { withCredentials: true }
      );
      ...
      setEvents((prev) =>
        prev.map((e) =>
          e._id === eventId
            ? {
                ...e,
                registeredUsers: [...(e.registeredUsers || []), currentUserId],
              }
            : e
        )
      );
  ...
  const handleDelete = async (eventId) => {
    ...
    try {
      await axios.delete(
        `${import.meta.env.VITE_API_BASE_URL}/event/${eventId}`,
        { withCredentials: true }
      );
  ...
  const handleDeleteFeedback = async (feedbackId) => {
    ...
    try {
      await axios.delete(
        `${import.meta.env.VITE_API_BASE_URL}/feedback/${feedbackId}`,
        { withCredentials: true }
      );
  ...
  const isUserRegistered = (event) =>
    ...
    event.registeredUsers.includes(currentUserId);
  ...
  const filteredEvents = events
    ...
    .sort((a, b) => {
      ...
      if (filters.sortBy === "registrations")
        return (
          (b.registeredUsers?.length || 0) - (a.registeredUsers?.length || 0)
        );
      return 0;
    });
      ...
      {isMobile ? (
        <div className="pt-20 pb-12">
          ...
          <div className="px-4 mb-6">
            <div className="text-center mb-6">
              ...
              <p
                className={`text-lg ${themeClasses.textSecondary} max-w-2xl mx-auto mb-6`}
              >
                Explore amazing opportunities and level up your skills through
                premium events.
              </p>
            </div>
            {/* Search */}
            ...
            {showFilters && (
              <div
                className={`${themeClasses.card} rounded-xl p-4 mt-4 border`}
              >
            ...
            {(!showFilters || true) && (
              <hr
                className="my-4 border-t border-gray-300 dark:border-gray-700 w-[100vw] relative left-1/2 right-1/2 -translate-x-1/2"
          ...
          <div className="px-4">
            {filteredEvents.length === 0 ? (
              <div className="text-center py-20">
                <div
                  className={`${themeClasses.card} border rounded-xl p-12 max-w-md mx-auto`}
                >
                  <Calendar
              ...
              <div className="space-y-4 hide-scrollbar">
                {filteredEvents.map((event) => {
                  const config =
                    eventTypeConfig[event.eventType] || eventTypeConfig.Other;
                  ...
                  return (
                    ...
                    >
                      ...
                      <div
                        className={`${
                          isDarkMode ? config.bgColorDark : config.bgColor
                        } border-b ${
                      ...
                      >
                        <div className="flex items-center justify-between mb-3">
                          <div
                            className={`flex items-center gap-2 px-3 py-1 rounded-full border ${
                              isDarkMode ? config.colorDark : config.color
                            } text-xs font-medium`}
                          >
                        ...
                        <h3
                          className={`text-lg font-bold ${themeClasses.text} line-clamp-2 mb-2`}
                        >
                          {event.title}
                        </h3>
                        <p
                          className={`${themeClasses.textMuted} text-sm line-clamp-2`}
                        >
                      ...
                      <div className="p-4">
                        ...
                        <button
                          ...
                          disabled={
                            isUserRegistered(event) || registering[event._id]
                          }
        ...
        <div className="pt-16">
          ...
          <div className="flex justify-center py-8 px-6">
            <div className="w-full max-w-4xl">
              ...
              <div className="text-center mb-8">
                ...
                <p
                  className={`text-xl ${themeClasses.textSecondary} max-w-3xl mx-auto mb-8`}
                >
                  Explore amazing opportunities and level up your skills through
                  premium events.
                </p>
                ...
                <div className="flex justify-center gap-8 mb-8">
                  ...
                  <div className="text-center">
                    <div className={`text-3xl font-bold ${themeClasses.text}`}>
                      {events.reduce(
                        (acc, e) => acc + (e.registeredUsers?.length || 0),
                        0
                      )}
                    </div>
                    <div className={`text-indigo-500 text-sm`}>
              ...
              {showFilters && (
                <div
                  className={`${themeClasses.card} border rounded-xl p-6 mb-6 max-w-2xl mx-auto`}
                >
              ...
              {(!showFilters || true) && (
                <hr
                  className="my-6 border-t border-gray-300 dark:border-gray-700 w-[100vw] relative left-1/2 right-1/2 -translate-x-1/2"
                  style={{ marginLeft: 0, marginRight: 0 }}
                />
              )}
            </div>
          ...
          <div className="flex h-screen overflow-hidden">
            ...
            <div
              className={`w-[30%] overflow-y-auto hide-scrollbar border-r rounded-2xl border-gray-200 dark:border-gray-700 ${themeClasses.background}`}
            >
            ...
            <div className="w-full lg:w-[70%] h-full overflow-y-auto hide-scrollbar">
              {selectedEvent ? (
                    ...
                    <div className="space-y-8">
                      ...
                      <div
                        className={`bg-gradient-to-r ${
                          eventTypeConfig[selectedEvent.eventType]?.gradient ||
                          eventTypeConfig.Other.gradient
                          ...
                          <div className="flex items-center justify-between mb-6">
                            <div className="flex items-center gap-4">
                              <div className="bg-white/20 p-3 rounded-xl backdrop-blur-sm">
                                {(() => {
                                  const IconComponent =
                                    eventTypeConfig[selectedEvent.eventType]
                                      ?.icon || eventTypeConfig.Other.icon;
                                  return (
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="lg:col-span-2 space-y-6">
                          {/* Event Details */}
                          <div
                            className={`${themeClasses.card} border rounded-2xl p-6`}
                          >
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              ...
                              >
                                ...
                                <div>
                                  ...
                                  <div
                                    className={`${themeClasses.textMuted} text-sm capitalize`}
                                  >
                                ...
                                >
                                  <div className="flex flex-wrap gap-3">
                                    ...
                                    <button
                                      onClick={() =>
                                        navigate(
                                          `/events/${selectedEvent._id}/add-feedback`
                                        )
                                      }
                          ...
                          >
                            ...
                            {feedbacks.length > 0 ? (
                                  ...
                                  >
                                    <div className="flex items-start justify-between mb-3">
                                      ...
                                      <div className="flex items-center gap-1">
                                        ...
                                        <span
                                          className={`ml-2 text-sm font-medium ${themeClasses.textSecondary}`}
                                        >
                                          {feedback.rating}/5
                                        </span>
                                      </div>
                              ...
                              <div className="text-center py-12">
                                ...
                                />
                                <p
                                  className={`${themeClasses.textMuted} text-lg`}
                                >
                                  No feedback yet
                                </p>
                                <p
                        ...
                        <div className="space-y-6">
                          {/* Registration Card */}
                          <div
                            className={`${themeClasses.card} border rounded-2xl p-6 shadow-2xl`}
                          >
                            <div className="text-center mb-6">
                              <div
                            ...
                            <div className="space-y-4 mb-6">
                              ...
                              >
                                ...
                                <span
                                  className={`font-semibold ${themeClasses.text} text-sm`}
                                >
                              ...
                              {selectedEvent.teamMin &&
                                selectedEvent.teamMax && (
                                  <div
                                    className={`flex justify-between items-center p-3 ${
                                      isDarkMode
                                        ? "bg-gray-800/30"
                          ...
                          >
                            <h3
                              className={`font-bold ${themeClasses.text} mb-4 flex items-center gap-2`}
                            >
                ...
                <div className="pt-8 px-8 text-center flex flex-col items-center">
                  ...
                  <p className={`${themeClasses.textMuted} mt-2 max-w-xl`}>
                    Choose an event from the list to view detailed information,
                    register, and see feedback from other participants.
                  </p>
                </div>
              )}
            </div>
