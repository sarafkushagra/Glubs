  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto mt-30 p-6 bg-purple-50 rounded shadow mb-10">
        ...
        <div className="mb-2"><b>Views:</b> {event.views}</div>
        <div className="mb-2"><b>Registration:</b> {event.registration}</div>
        <div className="mb-2"><b>Comments Count:</b> {event.commentsCount}</div>
        <div className="mb-4">
          <b>Media:</b>
