...
const AuthCard = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-400 via-purple-500 to-pink-500 dark:from-gray-900 dark:to-gray-800 px-4">
      <div className="relative w-full max-w-4xl bg-white/80 dark:bg-gray-900/80 backdrop-blur-md rounded-2xl shadow-2xl overflow-hidden flex flex-col md:flex-row transition-all duration-700">
